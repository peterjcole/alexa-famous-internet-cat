...
/*	public static final List<RecipeInstruction> INSTRUCTIONS = Arrays.asList(
	...
	public static final List<RecipeInstruction> INSTRUCTIONS = Arrays.asList(
		new RecipeInstruction(1, "Read recipe"),	
		new RecipeInstruction(2, "Get ingredients"),
		new RecipeInstruction(3, "Preheat oven"),
		new RecipeInstruction(4, "Make a huge mess because you are a cat"),
		new RecipeInstruction(5, "Order a pizza."),
		new RecipeInstruction(6, "Success!")
		);
